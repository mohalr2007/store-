  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-4">
        <div className="relative flex h-24 w-24 items-center justify-center rounded-full border border-[rgba(69,212,232,0.22)] bg-[rgba(255,255,255,0.22)] shadow-[0_0_40px_rgba(69,212,232,0.18)]">
